...
[task_local]
#京喜工厂招工互助
1 6,9,21 * * * jd_dreamFactory_help.js, tag=京喜工厂招工互助, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "1 6,9,21 * * *" script-path=jd_dreamFactory_help.js,tag=京喜工厂招工互助

===============Surge=================
京喜工厂招工互助 = type=cron,cronexp="1 6,9,21 * * *",wake-system=1,timeout=3600,script-path=jd_dreamFactory_help.js

============小火箭=========
京喜工厂招工互助 = type=cron,script-path=jd_dreamFactory_help.js, cronexpr="1 6,9,21 * * *", timeout=3600, enable=true
...
const newShareCodes = [
  'cR6akRvMKEZDQo6d_N7boA==',
  'FC1WxF0t01oReUkD3ih-Lw==',
  'wotQXakCeOom5OFicq29hw==',
  'Aor7O2L5WyXS4_oQTOdd5A=='
];
