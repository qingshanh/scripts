...
[task_local]
#京喜工厂开团
6 0,8,22 * * * jd_dreamFactory.js, tag=京喜工厂开团, img-url=https://github.com/58xinian/icon/raw/master/jdgc.png, enabled=true

================Loon==============
[Script]
cron "6 0,8,22 * * *" script-path=jd_dreamFactory.js,tag=京喜工厂开团

===============Surge=================
京喜工厂开团 = type=cron,cronexp="6 0,8,22 * * *",wake-system=1,timeout=3600,script-path=jd_dreamFactory.js
